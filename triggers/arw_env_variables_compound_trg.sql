...
-- =============================================================================
-- Trigger: arw_env_variables_compound_trg
-- Purpose: Automatically maintains audit columns (last_updated_by,
--          last_updated_on) on every update to arw_env_variables.
--
-- @author  Angel Flores (Developer)
-- @created September 09, 2026
-- @ticket  N/A (Fase 0 - modelo de datos inicial ARW)
-- =============================================================================
create or replace trigger arw_env_variables_compound_trg
for insert or update on arw_env_variables
compound trigger
...
end arw_env_variables_compound_trg;
/
