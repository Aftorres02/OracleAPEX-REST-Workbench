...
-- =============================================================================
-- Trigger: arw_collections_compound_trg
-- Purpose: Automatically maintains audit columns (last_updated_by,
--          last_updated_on) on every update to arw_collections.
--
-- @author  Angel Flores (Developer)
-- @created September 09, 2026
-- @ticket  N/A (Fase 0 - modelo de datos inicial ARW)
-- =============================================================================
create or replace trigger arw_collections_compound_trg
for insert or update on arw_collections
compound trigger
...
end arw_collections_compound_trg;
/
